...
class WebSecurity(val userDetailsService: UserDetailsServiceImpl,
                  ...
                  val connectedUserResolver: ConnectedUserResolver) : WebSecurityConfigurerAdapter() {
    ...
    override fun configure(http: HttpSecurity) {
        http.cors().and().csrf().disable().authorizeRequests()
                ...
                .and()
                .addFilter(JWTAuthenticationFilter(authenticationManager(), env!!.getRequiredProperty("spring.security.secret"), connectedUserResolver))
