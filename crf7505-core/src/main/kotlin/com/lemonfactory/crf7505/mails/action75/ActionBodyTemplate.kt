...
class ActionBodyTemplate: BodyTemplate<List<Mission>> {
    override fun generateBody(bodyContent: List<Mission>): String {
        return createHTML().div {
            displayAllMissions(bodyContent, "Pas de missions extérieures")
        }
    }
